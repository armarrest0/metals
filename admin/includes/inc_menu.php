...
$modules['05_rent']['05_rent_nopay'] = 'supplier_rent.php?act=nopay&status=1';
$modules['05_rent']['05_rent_setting'] = 'supplier_rent.php?act=list&status=1'; 
$modules['05_rent']['05_rent_out'] = 'supplier_rent.php?act=out&status=1';
$modules['05_rent']['05_rent_history'] = 'supplier_rent.php?act=history&status=1'; 
...
$modules['03_supplier_credit']['02_supplier_credit_loan'] = 'supplier_loan.php?act=list';
$modules['03_supplier_credit']['02_supplier_credit_master'] = 'supplier_loan.php?act=master';
$modules['03_supplier_credit']['02_supplier_credit_loan_history'] = 'supplier_loan.php?act=history';
// 微信权限
