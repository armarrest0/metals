...
E_D("replace into `ecs_supplier_nav` values('31','c','142','手机','1','2','0','supplier.php?go=category&amp;suppId=10&amp;id=142','middle','10');");
E_D("replace into `ecs_supplier_nav` values('32','c','139','台式机','1','4','0','supplier.php?go=category&amp;suppId=10&amp;id=139','middle','10');");
E_D("replace into `ecs_supplier_nav` values('33','c','140','笔记本','1','6','0','supplier.php?go=category&amp;suppId=10&amp;id=140','middle','10');");
E_D("replace into `ecs_supplier_nav` values('34','c','141','平板电脑','1','8','0','supplier.php?go=category&amp;suppId=10&amp;id=141','middle','10');");
