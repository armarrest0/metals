...
E_D("replace into `ecs_admin_action` values('255','0','chat','');");
E_D("replace into `ecs_admin_action` values('256','255','chat_settings','');");
E_D("replace into `ecs_admin_action` values('257','255','customer','');");
E_D("replace into `ecs_admin_action` values('258','255','third_customer','');");
E_D("replace into `ecs_admin_action` values('260','0','virtual','');");
E_D("replace into `ecs_admin_action` values('261','260','virtual_category','');");
E_D("replace into `ecs_admin_action` values('262','260','virtual_district','');");
E_D("replace into `ecs_admin_action` values('263','260','virtual_card_list','');");
E_D("replace into `ecs_admin_action` values('264','260','virtual_goods_sup','');");
E_D("replace into `ecs_admin_action` values('265','260','virtual_goods_list','');");
E_D("replace into `ecs_admin_action` values('266','260','virtual_validate','');");
E_D("replace into `ecs_admin_action` values('267','260','virtual_goods_add','');");
E_D("replace into `ecs_admin_action` values('268','7','pre_sale','');");
