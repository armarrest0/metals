...
E_D("replace into `ecs_nav` values('6','','0','礼包','0','11','0','package.php','middle');");
...
E_D("replace into `ecs_nav` values('11','','0','文章资讯','1','17','0','article_list.php','top');");
...
E_D("replace into `ecs_nav` values('25','c','2','服装服饰','0','19','0','category.php?id=2','middle');");
E_D("replace into `ecs_nav` values('26','','0','文章资讯','1','20','0','article_list.php','middle');");
