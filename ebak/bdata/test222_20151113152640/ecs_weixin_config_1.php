...
E_D("replace into `ecs_weixin_config` values('1','商之翼网络','qphp','wxfb046cea471546ee','6ee5779a091e8e295235aa528e96e707','感谢你的关注','helpmsg','恭喜您绑定成功！','0','0','1','1','','0','恭喜你订单提交成功！','您购买的商品（订单号：\$order_sn）已经发货请注意查收！快递号：\$shoping_code','1','请填写你的邮箱和密码，使用+分割。','','测试自动回复');");
E_D("replace into `ecs_weixin_config` values('2','','123123','123','123123','','','','0','0','0','0','','0','','','0','','','');");
