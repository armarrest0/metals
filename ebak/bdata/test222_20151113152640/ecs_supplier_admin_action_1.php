...
E_D("replace into `ecs_supplier_admin_action` values('220','0','chat','');");
E_D("replace into `ecs_supplier_admin_action` values('221','220','customer','');");
E_D("replace into `ecs_supplier_admin_action` values('210','0','virtual','');");
E_D("replace into `ecs_supplier_admin_action` values('211','210','virtual_card_list','');");
E_D("replace into `ecs_supplier_admin_action` values('212','210','virtual_goods_s','');");
E_D("replace into `ecs_supplier_admin_action` values('213','210','virtual_validate','');");
E_D("replace into `ecs_supplier_admin_action` values('214','210','virtual_goods_add','');");
E_D("replace into `ecs_supplier_admin_action` values('215','6','pre_sale','');");
