...
E_D("replace into `ecs_weixin_menu` values('9','1','商城首页','2','http://dcityweixin.68ecshop.com/mobile/weixin/oauth.php?id={id}&oid=1','12');");
...
E_D("replace into `ecs_weixin_menu` values('24','4','砸金蛋','3','article_133','0');");
