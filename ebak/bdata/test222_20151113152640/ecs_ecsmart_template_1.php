...
E_D("replace into `ecs_ecsmart_template` values('index','手机端首页广告4','/library/ad_position.lbi','0','16','1','4','68ecshopcom_mobile','');");
...
E_D("replace into `ecs_ecsmart_template` values('index','首页促销模块','/library/recommend_promotion.lbi','0','0','3','0','68ecshopcom_mobile','');");
E_D("replace into `ecs_ecsmart_template` values('index','首页推荐模块','/library/recommend_hot.lbi','2','0','6','0','68ecshopcom_mobile','');");
E_D("replace into `ecs_ecsmart_template` values('index','首页推荐模块','/library/recommend_new.lbi','1','0','6','0','68ecshopcom_mobile','');");
E_D("replace into `ecs_ecsmart_template` values('index','首页推荐模块','/library/recommend_best.lbi','0','0','6','0','68ecshopcom_mobile','');");
